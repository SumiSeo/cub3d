...
/*   Updated: 2024/11/07 18:45:24 by sokaraku         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_up(t_data *data)
{
	...
	new_x = data->posX + data->dirX * data->moveSpeed;
	new_y = data->posY + data->dirY * data->moveSpeed;
	if (map[(int)data->posX][(int)new_x] != '1')
		data->posX = new_x;
